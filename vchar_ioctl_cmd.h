...
#define IOCTL_GET_MICRO_S _IOC(_IOC_READ, 'k', 5, BUFFER_SIZE)
#define IOCTL_GET_NANO_S _IOC(_IOC_READ, 'k', 6, BUFFER_SIZE)
#define IOCTL_GET_TIME _IOC(_IOC_READ, 'k', 7, BUFFER_SIZE)
